...
public class smalltask2 {
	...
	// 2-write an if-else statement that assigns 1 to assigns 1 to x when y is equal to 100 
	// Otherwise 
	if (y==100) {
	    x=1;
	}else {
		...
		//-Write an if -else statement that assigns 0 to the variable b and assigns 1 to the
